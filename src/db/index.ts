...
function ensureDatabaseSchemaSynced() {
  ...
  createTableIfNotExists("global_sanctions", "id TEXT PRIMARY KEY NOT NULL, target_type TEXT NOT NULL, target_id TEXT NOT NULL, reason TEXT NOT NULL, created_at INTEGER NOT NULL");
  checkAndAddColumn("global_sanctions", "created_by", "TEXT");
  createTableIfNotExists("global_announcements", "id TEXT PRIMARY KEY NOT NULL, title TEXT NOT NULL, message TEXT NOT NULL, created_at INTEGER NOT NULL");
  checkAndAddColumn("global_announcements", "created_by", "TEXT");
  createTableIfNotExists("security_audit_logs", "id TEXT PRIMARY KEY NOT NULL, ip_address TEXT NOT NULL, action TEXT NOT NULL, status TEXT NOT NULL, timestamp INTEGER NOT NULL");
  checkAndAddColumn("security_audit_logs", "discord_id", "TEXT");
  checkAndAddColumn("security_audit_logs", "details", "TEXT");
  createIndexIfNotExists("idx_sec_audit_ip", "security_audit_logs", "ip_address");
  createIndexIfNotExists("idx_sec_audit_status", "security_audit_logs", "status");
  createTableIfNotExists("banned_ips", "ip_address TEXT PRIMARY KEY NOT NULL, reason TEXT NOT NULL, banned_by TEXT NOT NULL, banned_at INTEGER NOT NULL");
  checkAndAddColumn("banned_ips", "expires_at", "INTEGER");
  createTableIfNotExists("platform_alerts", "id TEXT PRIMARY KEY NOT NULL, code TEXT NOT NULL, message TEXT NOT NULL, created_at INTEGER NOT NULL");
  checkAndAddColumn("platform_alerts", "bank_id", "TEXT");
  checkAndAddColumn("platform_alerts", "severity", "TEXT DEFAULT 'warning'");
  checkAndAddColumn("platform_alerts", "is_open", "INTEGER DEFAULT 1");
  checkAndAddColumn("platform_alerts", "resolved_at", "INTEGER");
  checkAndAddColumn("platform_alerts", "resolved_by", "TEXT");
  ...
  createIndexIfNotExists("idx_platform_alerts_created", "platform_alerts", "created_at");
  createTableIfNotExists("used_payment_tokens", "token_hash TEXT PRIMARY KEY NOT NULL, used_at INTEGER NOT NULL");
  checkAndAddColumn("used_payment_tokens", "merchant_id", "TEXT");
  checkAndAddColumn("used_payment_tokens", "discord_id", "TEXT");
  checkAndAddColumn("used_payment_tokens", "amount_cents", "INTEGER");
  createIndexIfNotExists("idx_used_payment_tokens_merchant", "used_payment_tokens", "merchant_id");
  createIndexIfNotExists("idx_used_payment_tokens_used_at", "used_payment_tokens", "used_at");
  createTableIfNotExists("idempotency_keys", "id TEXT PRIMARY KEY NOT NULL, key TEXT NOT NULL, scope TEXT NOT NULL, status TEXT NOT NULL, created_at INTEGER NOT NULL, expires_at INTEGER NOT NULL");
  checkAndAddColumn("idempotency_keys", "status_code", "INTEGER");
  checkAndAddColumn("idempotency_keys", "response_json", "TEXT");
  ...
  createTableIfNotExists("customer_notifications", "id TEXT PRIMARY KEY NOT NULL, bank_id TEXT NOT NULL, discord_id TEXT NOT NULL, title TEXT NOT NULL, message TEXT NOT NULL, created_at INTEGER NOT NULL");
  ...
  createIndexIfNotExists("idx_customer_notifs_read", "customer_notifications", "is_read");
  createIndexIfNotExists("idx_customer_notifs_created", "customer_notifications", "created_at");
  ...
  checkAndAddColumn("bank_settings", "max_personal_accounts_per_user", "INTEGER");
  checkAndAddColumn("bank_settings", "max_business_accounts_per_user", "INTEGER");
  checkAndAddColumn("bank_settings", "max_total_accounts_per_user", "INTEGER");
