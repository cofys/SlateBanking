...
export const bankSettings = sqliteTable("bank_settings", {
  ...
  accountTiers: text("account_tiers", { mode: "json" }).$type<{ 
    id: string; 
    name: string; 
    description: string; 
    type: string; 
    ...
    autoApproveCreditCards?: boolean; 
    maxAutoApproveLoanAmount?: number; 
    customPrefix?: string | null; 
    namingMode?: string | null;
    maxAccountsPerUser?: number | null;
    exclusiveGroup?: string | null;
    mutuallyExclusiveTierIds?: string[];
  ...
  maxPersonalAccountsPerUser: integer("max_personal_accounts_per_user"),
  maxBusinessAccountsPerUser: integer("max_business_accounts_per_user"),
  maxTotalAccountsPerUser: integer("max_total_accounts_per_user"),
