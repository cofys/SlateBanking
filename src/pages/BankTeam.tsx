        ...
        <div className="bg-[#0f0f15] border border-white/10 rounded-xl p-6 mb-6">
          ...
          <form onSubmit={handleAdd} className="flex gap-4">
            <div className="flex-1">
              <label className="block text-xs font-medium text-white/50 mb-2 uppercase tracking-wide">Discord ID, MC Username, or UUID</label>
              <input name="discordId" required type="text" className="w-full bg-[#1a1a24] border border-white/10 rounded-lg px-4 py-2 text-sm text-white focus:outline-none focus:border-indigo-500" placeholder="123456789, notch, or UUID" />
            </div>
            <div className="flex-1">
        ...
        {staff.length === 0 ? (
          ...
          <table className="w-full text-left text-sm">
            <thead className="bg-[#1a1a24] text-white/50 border-b border-white/10">
              <tr>
                <th className="px-6 py-4 font-medium">Identifier (Discord/MC/UUID)</th>
