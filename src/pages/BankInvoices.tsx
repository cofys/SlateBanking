      ...
      <div className="flex flex-col md:flex-row justify-between items-stretch md:items-center gap-4 bg-[#0b0b12] border border-white/10 rounded-2xl p-4 shadow-xl">
        ...
        <div className="relative w-full md:w-80">
          ...
          <input
            ...
            className="w-full bg-[#11111a] border border-white/10 rounded-xl py-2 pl-10 pr-4 text-sm text-white placeholder:text-zinc-600 focus:outline-none focus:border-indigo-500 transition-colors font-medium"
          />
        </div>
      </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-[#11111a] border border-white/10 rounded-xl p-3 text-sm text-white focus:outline-none focus:border-indigo-500 transition-colors font-medium"
                    >
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="0.00"
                        className="w-full bg-[#11111a] border border-white/10 rounded-xl py-3 pl-8 pr-4 text-sm text-white focus:outline-none focus:border-indigo-500 transition-colors font-mono"
                      />
                    </div>
                  </div>
