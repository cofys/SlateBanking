...
const regex = /<\/div>\s*\{user && \(\s*<div className="flex items-center gap-4 bg-\[#0a0a0f\] border border-white\/5 rounded-2xl p-2 px-4 shadow-xl">/;
...
if (code.match(regex)) {
    ...
    console.log("Replaced header with regex");
} else {
